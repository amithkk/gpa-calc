...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.gpaDidChange = function (newGPA) {
        console.log('GPADIDCHANGE:', newGPA);
        this.gpa = newGPA;
    };
    AppComponent.prototype.triggerCalculate = function () {
        this.child.recalcGPA();
    };
    AppComponent.prototype.gpaCalculatedOnce = function () {
        this.gpaCalcOnce = true;
    };
    AppComponent.prototype.hasLocalStorage = function () {
...
/* harmony import */ var countup_js_angular2__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! countup.js-angular2 */ "./node_modules/countup.js-angular2/fesm5/countup.js-angular2.js");
...
var SubContainerComponent = /** @class */ (function () {
    function SubContainerComponent(toastr) {
        this.toastr = toastr;
    ...
    SubContainerComponent.prototype.ngOnInit = function () {
        var list = localStorage.getItem('gpaList');
    ...
    SubContainerComponent.prototype.resetDefaults = function () {
        this.subs = [{ grd_p: 9, credit: 4 }];
    };
    SubContainerComponent.prototype.onAddSubject = function () {
        this.subs.push({
            grd_p: 0,
            credit: 0,
        });
    };
    SubContainerComponent.prototype.recalcGPA = function () {
        var num = 0;
        var den = 0;
        var olds = this.subs;
        this.subs = this.subs.filter((function (value) { return value.credit !== 0; }));
...
var SubjectComponent = /** @class */ (function () {
    ...
    SubjectComponent.prototype.onChangePointer = function (event) {
    ...
    SubjectComponent.prototype.onChangeCredit = function (event) {
        var change = event.target.value;
        if (isNaN(change)) {
            this.credit = 0;
        }
